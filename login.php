...
<!doctype html>
<!--[if lt IE 7]>
<html class = "no-js ie6 oldie" lang = "<?php echo $this->language; ?>"> <![endif]-->
<!--[if IE 7]>
<html class = "no-js ie7 oldie" lang = "<?php echo $this->language; ?>"> <![endif]-->
<!--[if IE 8]>
<html class = "no-js ie8 oldie" lang = "<?php echo $this->language; ?>"> <![endif]-->
<!--[if gt IE 8]><!-->
...
<head>
	...
	<!-- favicon -->
	<link rel = "stylesheet" href = "<?php echo $tpath; ?>/css/print.css?v=1.0.0" type = "text/css"/>
	<!-- stylesheet -->
	<script src = "<?php echo $tpath; ?>js/modernizr.js"></script>
	<!-- put all javascripts at the bottom, accept of modernizr.js -->
</head>
...
<div data-role = "page" id = "login">
	<div data-role = "content">
		...
		<h2 class = "subtitle">
			<a href = "index.php"><?php echo $this->params->get('showSiteName') ? $app->getCfg('sitename') . " " . JText::_('JADMINISTRATION') : JText::_('JADMINISTRATION'); ?></a>
		</h2>
